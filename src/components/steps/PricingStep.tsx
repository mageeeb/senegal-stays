...
//                     {/* Remplacement de l'icône $ par le libellé FCFA */}
//                     <span className="px-2 py-0.5 rounded bg-muted text-xs font-medium">FCFA</span>
//                     Fixez votre tarif
//                 </h3>
...
//                                     <p className="text-xs text-red-600 mt-1">Doit être ≥ à la durée minimale.</p>
//                                 )}
//                             </div>
//                         </div>
//                     )}
                    ...
                    FCFA
                            ...
                            <div>
                                ...
                                <Input
                                    id="min_months"
                                    type="number"
                                    value={data.min_months || 1}
                                    min={1}
                                    onChange={(e) => updateData({ min_months: parseInt(e.target.value) || 1 })}
                                />
                                {(data.min_months !== undefined && data.min_months < 1) && (
                                    <p className="text-xs text-red-600 mt-1">Minimum 1 mois.</p>
                                )}
                            ...
                            <div>
                                ...
                                <Input
                                    id="max_months"
                                    type="number"
                                    value={data.max_months || 12}
                                    min={1}
                                    onChange={(e) => updateData({ max_months: parseInt(e.target.value) || 12 })}
                                />
                                {(data.max_months && data.min_months && data.max_months < data.min_months) && (
                                    <p className="text-xs text-red-600 mt-1">Doit être ≥ à la durée minimale.</p>
                                )}
